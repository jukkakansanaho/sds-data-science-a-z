...
def main():
    ...
    * All input data is modified and results stored to a new file.
    """
    filepath         = '../projects/Office-Supplies-Store-20200212/2-prepared-data/PART3-S6-CustomerList.csv'
    targetfile       = '../projects/Office-Supplies-Store-20200212/2-prepared-data/PART3-S6-CustomerList-re.csv'
    re_rules                    = {}
